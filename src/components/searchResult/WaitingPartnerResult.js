                    ...
                    <GetPartner
                      ...
                      status={
                        item.status === 'IN_REVIEW'
                          ? '승인대기'
                          : item.status === 'IN_MODIFICATION'
                          ? '수정요청'
                          : item.status === 'READY_FOR_CONTRACT'
                          ? '계약대기'
...
function GetPartner(props) {
  ...
  return (
    <tr>
      ...
      <td>
        <a href={props.BUSINESS_LICENSE} download={props.BUSINESS_LICENSE}>
          <img src={picture} />
        </a>
      </td>
      <td>
        <a href={props.CARRIERS_CERT} download={props.CARRIERS_CERT}>
          <img src={picture} />
        </a>
      </td>
      <td>
        <a href={props.DRIVER_LICENSE} download={props.DRIVER_LICENSE}>
          <img src={picture} />
        </a>
      </td>
      <td>
        <a href={props.BANKBOOK} download={props.BANKBOOK}>
          <img src={picture} />
        </a>
      </td>
      <td>
